...
export type TopicType = 'slides' | 'quiz';
...
export const mockTopics: Topic[] = [
  {
    id: 'pmhnp-bc-quiz',
    title: 'PMHNP-BC 🔥',
    description: 'Practice questions for the PMHNP-BC certification exam',
    imageUrl:
    ...
    slides: [
      {
        id: '1',
        content:
          'Key components of a psychiatric assessment include mental status examination, history taking, and risk assessment.',
      },
      {
        id: '2',
        content:
          'The mental status examination evaluates appearance, behavior, mood, affect, thought process, thought content, cognition, insight, and judgment.',
      },
      {
        id: '3',
        content:
          'Clinical interviews should follow a structured approach while maintaining therapeutic rapport.',
      },
    ],
  },
  {
    ...
    slides: [
      {
        id: '1',
        content:
          'Antidepressants work by affecting neurotransmitters like serotonin, norepinephrine, and dopamine.',
      },
      {
        id: '2',
        content:
          'SSRIs are first-line treatments for depression and anxiety disorders due to their favorable side effect profile.',
      },
      {
        id: '3',
        content:
          'Common side effects include GI disturbances and initial anxiety.',
      },
    ],
  },
  {
    ...
    description:
      'Understanding and treating major depressive disorder and bipolar disorders',
    ...
    slides: [
      {
        id: '1',
        content:
          'Major Depressive Disorder requires at least 5 symptoms present for 2 weeks.',
      },
      {
        id: '2',
        content:
          'Key symptoms include depressed mood, anhedonia, and changes in sleep/appetite.',
      },
      {
        id: '3',
        content:
          'Treatment often combines medication with psychotherapy for optimal outcomes.',
      },
    ],
  },
  {
    ...
    slides: [
      {
        id: '1',
        content:
          'Generalized Anxiety Disorder involves excessive worry about multiple areas of life.',
      },
      {
        id: '2',
        content:
          'Treatment typically includes both medication and psychotherapy.',
      },
      {
        id: '3',
        content:
